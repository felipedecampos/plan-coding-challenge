<header class="mb-3 shadow">
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            {{
                Form::open([
                    'route' => 'tictactoe.restart',
                    'name' => 'tictactoe-restart',
                    'id' => 'tictactoe-restart',
                    'class' => 'form-inline my-2 my-lg-0'
                ])
            }}
                {{
                    Form::hidden(
                        'tictactoe-restart-input',
                        1,
                        ['id' => 'tictactoe-restart-input', 'class' => 'form-control']
                    )
                }}
            ...
            {{
                ...
                {{
                    Form::hidden(
                        'tictactoe-finish-input',
                        1,
                        ['id' => 'tictactoe-finish-input', 'class' => 'form-control']
                    )
                }}
